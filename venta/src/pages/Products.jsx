...
const Products = ({ darkMode, onThemeToggle, isAuthenticated, user, onLogout }) => {
  ...
  // === MODIFICADO: Actualizar stock usando API + AlertModal ===
  ...
  return (
    <div className={darkMode ? 'dark' : ''}>
      <div className="min-h-screen bg-gray-50 flex flex-col">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Ej: Lácteos, Ropa, Papelería"
                  />
                </div>
              </div>
        ...
        {/* Modal de reabastecimiento masivo */}
        {showLowStockModal && (
          <Modal
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Ej: Cuaderno cuadriculado 100 hojas"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Código Interno *
                    <span className="text-xs text-gray-500 ml-2">(debe ser único)</span>
                  </label>
                  <Input
                    type="text"
                    value={newProduct.code}
                    onChange={(e) => setNewProduct({ ...newProduct, code: e.target.value.toUpperCase() })}
                    placeholder="Ej: PAP001 (automático si lo dejas vacío)"
                  />
                  {newProduct.name && !newProduct.code && (
                    <p className="text-xs text-primary-600 mt-1">
                      Sugerido: <strong>
                        {newProduct.name.trim().toUpperCase().replace(/[^A-Z0-9]/g, '').substring(0, 6) +
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Ej: Papelería, Útiles escolares"
                  />
                </div>
              </div>
              <div className="grid grid-cols-3 gap-4">
